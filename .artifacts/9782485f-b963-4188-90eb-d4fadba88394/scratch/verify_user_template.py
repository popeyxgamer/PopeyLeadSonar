...
{{{{Weitere {{Informationen|Details}} und Referenzen|Mehr über nasze Leistungen}} {{finden Sie auf|entnehmen Sie bitte unserer Website}} SDASDAS|{{Gerne können Sie sich auf|Informieren Sie sich gerne unter}} SDASDAS {{ein Bild von unseren Arbeiten machen|weiter über uns informieren}}.}}

{{{{Melden Sie sich {{gerne|jederzeit}} {{unter|telefonisch unter}} 015510657291|{{Treten Sie {{gerne|}} mit uns in Kontakt|Rufen Sie uns {{gerne|jederzeit}} an}} {{unter|}} 015510657291}} {{oder antworten Sie {{direkt|einfach}} auf diese E-Mail|für ein {{erstes|kurzes}} Gespräch}}.|{{Über eine {{kurze|rückmeldende}} Nachricht|Über eine Rückantwort}} {{würden wir uns {{sehr|}} freuen|freue ich mich}}.}}

{{{{Beste|Herzliche|Freundliche}} Grüße|{{Mit {{besten|freundlichen}} Grüßen}}}}"""

print("--- Testing 5 random variants ---")
for i in range(5):
    print(f"\nVARIANT {i+1}:")
    ...
    if "{{" in result or "}}" in result:
        print("ERROR: Remaining brackets found!")
